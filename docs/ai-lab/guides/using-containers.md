...
If the container you were planning to use is missing software required for your work, you can follow this guide for [adding packages to a container](https://hpc.aau.dk/ai-lab/additional-guides/adding-packages-to-a-container/){target=_blank}. The guide will show how to create a copy of the container and modify it.
