...
!!! info "Not for confidential data"
    With AI-LAB you are only allowed to work with data that is **not confidential** according to [AAU’s data classification model](https://www.security.aau.dk/data-classification){target="_blank} (classified as level 1).
...
[Get access to AI-LAB](/ai-lab/how-to-access){ .md-button .md-button--primary }

## Features

<div class="grid cards" markdown>

-   __Access powerful GPUs__

    Access powerful GPUs for model training, simulations, and large-scale data analysis in student projects.

    ---

    ![Access powerful GPUs](/assets/img/ai-lab/ai-lab-feature-1.png)

-   __Deep Learning Capabilities__

    Use integrated frameworks like PyTorch and TensorFlow for rapid experimentation and neural network training.

    ---

    ![Deep Learning Capabilities](/assets/img/ai-lab/ai-lab-feature-2.png)

-   __Efficient Batch Processing__

    Run jobs through Slurm for smooth scheduling, batch execution, and practical workload management.

    ---

    ![Efficient Batch Processing](/assets/img/ai-lab/ai-lab-feature-3.png)

-   __Student-friendly learning environment__

    Built for courses and projects, with practical GPU access and a clear workflow for hands-on experimentation.

    ---

    ![Student-friendly learning environment](/assets/img/ai-lab/ai-lab-feature-4.png)
