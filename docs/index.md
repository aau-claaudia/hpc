...
| Platform | Details | Target users | Quicklinks |
| --- | --- | --- | --- |
| **DeiC Throughput HPC** | National Danish throughput resources (Computerome, GenomeDK, Sophia) with access via DeiC local or national resource pools and call-based applications. | <span class="target-user-tag target-user-tag--researchers">Researchers</span> | [:lucide-arrow-right: About](/external-hpc/deic-resources/)<br>[:lucide-arrow-right: Application form](https://forms.office.com/e/DxRA4hPK84) |
| **LUMI** | EuroHPC-funded supercomputer in Finland for scalable CPU/GPU projects, where AAU users can start with local pool access and scale to larger national/EuroHPC grants. | <span class="target-user-tag target-user-tag--researchers">Researchers</span> | [:lucide-arrow-right: About](/external-hpc/lumi/)<br>[:lucide-arrow-right: Application form](https://forms.office.com/e/4XC48iVu4S) |
| **EuroHPC** | European access-call system for applying to multiple supercomputers (e.g., benchmark, development, regular, and extreme-scale allocations). | <span class="target-user-tag target-user-tag--researchers">Researchers</span> | [:lucide-arrow-right: About](/external-hpc/eurohpc-resources/) |
