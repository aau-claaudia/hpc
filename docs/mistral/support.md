...
For technical questions about the products — API errors, model behaviour, interface bugs, or feature availability — use Mistral's own support channels.

### Submit a support ticket

Mistral support is accessed through a chat window built into both Vibe and AI Studio. When you open it, you will be asked to set the priority of your request and describe your issue. A ticket is then created and the Mistral support team will respond. You can always return to a ticket through the same *Help and Resources* interface. [See more](https://help.mistral.ai/en/articles/347458-how-do-i-contact-support){target="_blank"}

**In Vibe**, click the small icon in the bottom right corner and select *Contact us*.

![Le Chat support icon](/assets/img/mistral/support/le_chat1.png){style=max-height:450px;}

**In AI Studio**, click *Help and Resources* in the navigation and select *Contact us*.

![AI Studio support icon](/assets/img/mistral/support/ai-studio.png){style=max-height:450px;}

### Documentation

Mistral have a thorough documentation covering both Vibe and AI Studio:

| Resource | URL | Description |
|---|---|---|
| Help centre | [help.mistral.ai](https://help.mistral.ai/en/){target="_blank"} | FAQs and articles covering Vibe, AI Studio, accounts, and troubleshooting |
...
The Mistral Discord server is a good place to ask technical questions and get quick answers from fellow mistral users.
...
| Problem | Where to go |
|---|---|
| Cannot log in to Vibe | Contact CLAAUDIA via the [Serviceportal](https://aau.service-now.com/serviceportal){target="_blank"} |
