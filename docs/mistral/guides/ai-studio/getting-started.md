...
!!! warning "Select the dedicated workspace for Level 2 or 3 data"
    ...
    If you do not yet have a dedicated workspace, apply through the [Serviceportal](/mistral/how-to-access/#step-2-request-a-dedicated-workspace). API keys are issued only after Grants and Contracts has assessed the project.

Click the workspace selector in the top-left corner and select your named workspace.
...
!!! info "Need a dedicated workspace?"
    A dedicated workspace is required for API keys and for Level 2 or 3 data. We will ask for a WorkZone case number before an API key is issued. See [How to Access Mistral](/mistral/how-to-access/).
