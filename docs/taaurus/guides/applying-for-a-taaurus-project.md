...
- [Start a data management plan (DMP)](https://dmp.deic.dk/plans/new)
    
    >We recommend using DeiC DMP, but other DMP tools are also acceptable.

!!! info "Timing of approvals"
    These items do not need to be fully approved to submit Part 1, but they must be approved before you submit Part 2.
...
Use [this modification form](https://serviceportal.aau.dk/serviceportal?id=sc_cat_item&sys_id=5bfc5930839a625053711d447daad36c) if you need to change roles/rights related to TAAURUS of an ITS employee. -->

---

## Processing of your request

You will receive an email with a link to your project request on AAU Service Portal when your request has been approved.
...
Once your project is active, we recommend reading the [TAAURUS guides](/taaurus/guides/login/)