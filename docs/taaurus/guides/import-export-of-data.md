...
!!! info "Temporary solution"
    ...
    **For importing data**, please describe in your service request:
    - What should be imported
    - How much data (size/volume)
    - Where the data comes from (source location)

    **For exporting data**, please provide in your service request:
    - The path to what should be exported from your TAAURUS project (e.g., `/media/project/export/your-files/`)
