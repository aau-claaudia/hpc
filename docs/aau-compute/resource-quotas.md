...
* Find the application form: [AAU Compute: Request access to deadline resources](https://aau.service-now.com/serviceportal?id=sc_cat_item&sys_id=22a816638322be5053711d447daad379).
...
* Learn more about [launching unprivileged jobs on proprietary nodes](/ai-cloud/additional-guides/run-jobs-on-proprietary-nodes).
